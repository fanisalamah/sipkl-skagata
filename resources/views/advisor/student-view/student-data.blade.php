    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <a href="{{ route('advisor.student.add') }}" class="btn icon icon-left btn-primary">
                     ...
                     Tambah Data</a>                          
                            <div class="btn-group" role="group">
                              ...
                              <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('advisor.download.template.student', '?file=Template_student.xlsx') }}">Download Template</a></li>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{ route('advisor.upload.student') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="18%">
                                    <a href="{{ route('advisor.student.edit', $user->id) }}" class="btn btn-info"> Edit </a>
                                        <button type="submit" class="btn btn-danger" id="delete"
                                        onclick="sweetConfirm('/advisor/student/delete/{{ $user->id }}', 'Data Siswa')">Hapus</button>                                   
                                </td>
                            </tr>
                            @endforeach
