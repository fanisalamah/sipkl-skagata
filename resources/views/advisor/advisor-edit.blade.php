        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Data Advisor</h3>
                    <p class="text-subtitle text-muted">Form Edit Advisor </p>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form method="post" action="{{ route('advisor.update', $editData['users']->id) }}">
                                    @csrf
                                    @method('put')
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mandatory">
                                                ...
                                                <input type="text" name="nip" id="nip" class="form-control" value="{{ $editData['users']->nip }}" data-parsley-required="true">
                                            </div>
                                        </div>
